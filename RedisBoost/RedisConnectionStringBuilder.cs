...
namespace RedisBoost
{
	public class RedisConnectionStringBuilder: DbConnectionStringBuilder
	{
		...
		public RedisConnectionStringBuilder(string host, int port = RedisConstants.DefaultPort, int dbIndex = 0) : this(string.Format("data source={0}:{1};initial catalog=\"{2}\"", host, port, dbIndex))
		{
		}
